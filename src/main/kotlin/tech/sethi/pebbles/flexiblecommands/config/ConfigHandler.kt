...
object ConfigHandler {
    ...
    data class CommandConfig(
        ...
        val cooldownSeconds: Int = 0,               // Cooldown in seconds for command usage
        val cooldownMessage: String = "<red>This command is on cooldown. Please wait {remaining} seconds.",
